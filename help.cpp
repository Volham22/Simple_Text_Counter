...
void printHelp(string unknowArgs)
{
    ...
    cout << "Use : Text_Counter <text_file_path> <numbers option>" << endl;
}

void printUserHelp()
{
    cout << "============================================================================" << endl;
    cout << "Syntax : Text_Counter <text_file_path> <numbers option>" << endl;
...
void printTooMuchArguments()
{
    ...
    cout << " Text_Counter <text_file_path> <numbers option>" << endl;
}
